...
<main>
	<div class="col-12 col-lg-10 mx-auto h-100">
		...
		<div class="col-lg-7 col-12 text-center mx-auto shop-nav-category mt-4 mb-lg-0 pb-2">Sale's</div>
		<div class="col-12 col-lg-10 mx-auto row border-top border-dark mt-4 justify-content-center p-md-4">
			...
			<?php } ?>
			<div class="w-100 text-center mx-auto mt-2"><a class="show-more-link text-decoration-none text-secondary"
					href="sales.php">Show more...</a></div>
		</div>
	</div>
</main>
